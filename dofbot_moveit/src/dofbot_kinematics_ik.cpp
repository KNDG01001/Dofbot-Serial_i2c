...
int main(int argc, char **argv) {
    ...
    auto node = rclcpp::Node::make_shared("dofbot_kinematics_ik");
    
    string share_dir = ament_index_cpp::get_package_share_directory("dofbot_moveit");
    string urdf_file = share_dir + "/urdf/dofbot.urdf";
    ...
    if (dofbot.dofbot_getIK(urdf_file.c_str(), targetXYZ, targetRPY, outjoints)) {
