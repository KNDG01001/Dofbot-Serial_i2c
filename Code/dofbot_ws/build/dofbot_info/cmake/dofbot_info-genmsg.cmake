...
get_filename_component(_filename "/home/yahboom/dofbot_ws/src/dofbot_info/srv/kinemarics.srv" NAME_WE)
add_custom_target(_dofbot_info_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "dofbot_info" "/home/yahboom/dofbot_ws/src/dofbot_info/srv/kinemarics.srv" ""
)
...
_generate_srv_cpp(dofbot_info
  "/home/yahboom/dofbot_ws/src/dofbot_info/srv/kinemarics.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dofbot_info)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dofbot_info\")")
  # install generated code
  install(
